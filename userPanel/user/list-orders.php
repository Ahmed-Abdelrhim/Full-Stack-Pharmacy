...
<div class="container">
    ...
    <?php foreach ($orders as $data) { ?>
        <div class="card" style="width: 18rem;">
            <!-- Show Order Details -->
            <?php if ($data['med_id'] == $row['id']) { ?>
                <img src="../../Images/<?php echo $row['medicine_image']; ?>" alt="product-image" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title"><?php echo $row['medicine_title'] ?></h5>
                    <p class="card-text"><?php echo $row['medicine_description'] ?></p>
